...
class yolov9_detection(PTServingBaseService):
    def __init__(self, model_name, model_path):
        ...
        # self.model = Yolov9_on_pt(model_path, conf_thres=0.15, iou_thres=0.45, device='cpu')
        self.model = Yolov9_on_onnx(onnx_model=model_path.replace('.pt', '.onnx'), conf_thres=0.4, iou_thres=0.01, device='cpu')
