...
from src.controller.yolov9 import yolov9c_detect

from src.config.param import START, RUNNING, YOLOV9_DETECTING, SORTING
            ...
            try:
                ...
                match current_state:
                    ...
                    case "YOLOV9_DETECTING":
                        ...
                        self.conveyor_belts_stopped()
#=================================test===============================
                        # img_path = "/home/orangepi/yolov9_rknn_Cplusplus/examples/rknn_yolov9_demo_dfl_open/images/test_2.png"
                        # capture a frame
                        self.img_path = self.video_handler.start()
                        out_path,detected_num = yolov9c_detect(self.img_path)
                        if detected_num > 0:
...
#=================================end test===============================
                        # TODO: Implement YOLOv9 object detection\
                        time.sleep(5)
