...
CLASSES = ['mouse_biste','spur','short','open','5']
...
def detect(img_path):
    ...
    ort_session = ort.InferenceSession("/home/orangepi/huawei-cloud-orangepi-controller/src/controller/yolov9/weights/yolov9c.onnx")
    # ort_session = ort.InferenceSession("/home/orangepi/huawei-cloud-orangepi-controller/src/controller/yolov9/weights/bestbig_0302_converted_4515.onnx")
    ...
    cv2.imwrite('./test_onnx.jpg', orig)
    output_path = 'test_onnx.jpg'
    error_num = len(predbox)
...
if __name__ == '__main__':
    print('This is main ....')
    GenerateMeshgrid()
    img_path = "/home/orangepi/yolov9_rknn_Cplusplus/examples/rknn_yolov9_demo_dfl_open/images/test.png"
